...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\etudiantscontroller' => 'AppBundle\\Controller\\EtudiantsController',
            'appbundle\\controller\\personnecontroller' => 'AppBundle\\Controller\\PersonneController',
            'appbundle\\controller\\tachecontroller' => 'AppBundle\\Controller\\TacheController',
            'appbundle\\form\\etudiantstype' => 'AppBundle\\Form\\EtudiantsType',
            'appbundle\\form\\personnetype' => 'AppBundle\\Form\\PersonneType',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Controller\\EtudiantsController' => 'getEtudiantsControllerService.php',
            'AppBundle\\Controller\\PersonneController' => 'getPersonneControllerService.php',
            'AppBundle\\Controller\\TacheController' => 'getTacheControllerService.php',
            'AppBundle\\Form\\EtudiantsType' => 'getEtudiantsTypeService.php',
            'AppBundle\\Form\\PersonneType' => 'getPersonneTypeService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\EtudiantsType' => true,
            'AppBundle\\Form\\PersonneType' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MXFpzUBzzM', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xAphR7n7MM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O9UTluP529', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w7idjaih6E', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NGbs7D30h4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('15175d3591042cd4cfe193becded10253541bbd2')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AppBundle/Resources/views'), '!App');
        $instance->addPath(($this->targetDirs[3].'\\src\\Wadii\\FirstBundle/Resources/views'), 'WadiiFirst');
        $instance->addPath(($this->targetDirs[3].'\\src\\Wadii\\FirstBundle/Resources/views'), '!WadiiFirst');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('15175d3591042cd4cfe193becded10253541bbd2');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WadiiFirstBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Wadii\\FirstBundle'),
                    'namespace' => 'Wadii\\FirstBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WadiiFirstBundle' => 'Wadii\\FirstBundle\\WadiiFirstBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'gomycodedb',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'wadii.jlassi@gmail.com',
            'mailer_password' => 'wadii2013',
            'secret' => '15175d3591042cd4cfe193becded10253541bbd2',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '15175d3591042cd4cfe193becded10253541bbd2',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'wadii.jlassi@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'wadii2013',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'wadii.jlassi@gmail.com' => 'wadii.jlassi@gmail.com',
            ),
